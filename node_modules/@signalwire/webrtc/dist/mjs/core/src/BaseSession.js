import { uuid, getLogger, checkWebSocketHost, timeoutPromise, parseRPCResponse, safeParseJson, isJSONRPCResponse, isSATAuth, } from './utils';
import { DEFAULT_HOST, WebSocketState } from './utils/constants';
import { RPCConnect, DEFAULT_CONNECT_VERSION, RPCDisconnectResponse, RPCPingResponse, } from './RPCMessages';
import { authErrorAction, authSuccessAction, socketMessageAction, sessionDisconnectedAction, sessionReconnectingAction, } from './redux/actions';
...
export class BaseSession {
    constructor(options) {
        ...
        this.uuid = uuid();
        this.connectVersion = DEFAULT_CONNECT_VERSION;
    ...
    get connecting() {
        var _a;
        return ((_a = this._socket) === null || _a === void 0 ? void 0 : _a.readyState) === WebSocketState.CONNECTING;
    }
    get connected() {
        var _a;
        return ((_a = this._socket) === null || _a === void 0 ? void 0 : _a.readyState) === WebSocketState.OPEN;
    }
    get closing() {
        var _a;
        return ((_a = this._socket) === null || _a === void 0 ? void 0 : _a.readyState) === WebSocketState.CLOSING;
    }
    get closed() {
        return this._socket
    ...
    async _pingHandler(payload) {
        ...
        await this.execute(RPCPingResponse(payload.id, (_a = payload === null || payload === void 0 ? void 0 : payload.params) === null || _a === void 0 ? void 0 : _a.timestamp));
    }
    /**
