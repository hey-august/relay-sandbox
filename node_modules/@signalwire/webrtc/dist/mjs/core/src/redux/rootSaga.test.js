...
import rootSaga, { sessionStatusWatcher, initSessionSaga, sessionAuthErrorSaga, } from './rootSaga';
import { sessionChannelWatcher } from './features/session/sessionSaga';
import { sessionActions } from './features';
import { sessionDisconnectedAction, sessionReconnectingAction, sessionForceCloseAction, authSuccessAction, authErrorAction, authExpiringAction, destroyAction, initAction, reauthAction, } from './actions';
...
describe('sessionStatusWatcher', () => {
    ...
    it('should fork startSaga on authSuccess action', () => {
        ...
        const firstSagaTask = createMockTask();
    ...
    it('should fork sessionAuthErrorSaga on authError action and emit destroyAction', () => {
        ...
        return expectSaga(sessionStatusWatcher, options)
            ...
            .fork(sessionAuthErrorSaga, Object.assign(Object.assign({}, options), { action }))
            .silentRun()
            .then(() => {
