 ...
 */
export const PRODUCT_PREFIX_PUBSUB = 'chat';
...
export const GLOBAL_VIDEO_EVENTS = ['room.started', 'room.ended'];
 ...
 * @internal
 */
export const INTERNAL_GLOBAL_VIDEO_EVENTS = GLOBAL_VIDEO_EVENTS.map((event) => `${PRODUCT_PREFIX_VIDEO}.${event}`);
