import { checkWebSocketHost, isLocalEvent, timeoutPromise, toLocalEvent, validateEventsToSubscribe, } from './';
...
describe('checkWebSocketHost', () => {
    ...
    it('should do nothing if protocol is already present', () => {
        ...
        expect(checkWebSocketHost('ws://example.com:8082')).toEqual('ws://example.com:8082');
        expect(checkWebSocketHost('wss://test.example.com')).toEqual('wss://test.example.com');
...
describe('toLocalEvent', () => {
    it('should convert the event to our local event syntax', () => {
        expect(toLocalEvent('video.room.started')).toEqual(`video.${LOCAL_EVENT_PREFIX}.room.started`);
    });
});
