import { RPCConnect, RPCReauthenticate, RPCPing, RPCPingResponse, RPCExecute, RPCDisconnectResponse, VertoBye, VertoAttach, VertoInfo, VertoInvite, VertoModify, DEFAULT_CONNECT_VERSION, } from './index';
jest.mock('uuid', () => {
    return {
