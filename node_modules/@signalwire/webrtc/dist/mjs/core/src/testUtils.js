 ...
 * @returns Redux Store
 */
export const configureJestStore = (options) => {
    return configureStore(Object.assign({ userOptions: {
            project: PROJECT_ID,
            token: TOKEN,
            devTools: false,
            emitter: new EventEmitter(),
        }, SessionConstructor: BaseSession, runSagaMiddleware: false }, options));
};
/**
...
export const rpcConnectResultVRT = {
...
export const createSwEventChannel = () => multicastChannel();
export const createSessionChannel = () => channel();
