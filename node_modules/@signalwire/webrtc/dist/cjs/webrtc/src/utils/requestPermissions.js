 ...
 * ```
 */
const requestPermissions = (constraints) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const stream = yield (0, getUserMedia_1.getUserMedia)(constraints);
        (0, primitives_1.stopStream)(stream);
    }
    catch (error) {
        throw error;
    }
