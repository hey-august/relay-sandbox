...
describe('RPC Messages', () => {
    describe('RPCConnect', () => {
        it('should generate the message with token', function () {
            ...
            const message = (0, index_1.RPCConnect)({ authentication });
            expect(message).toStrictEqual({
                ...
                params: {
                    ...
                    version: index_1.DEFAULT_CONNECT_VERSION,
                },
            });
        });
        it('should generate the message using sub-params', function () {
            const authentication = { project: 'project', token: 'token' };
            const message = (0, index_1.RPCConnect)({
                authentication,
                protocol: 'old-proto',
                contexts: ['test'],
            });
    ...
    describe('RPCReauthenticate', () => {
        it('should generate the message', function () {
            const message = (0, index_1.RPCReauthenticate)({
                project: 'project',
                jwt_token: 'jwt',
            });
            expect(message).toStrictEqual({
    ...
    describe('RPCPing', () => {
        it('should generate the message', function () {
            ...
            const message = (0, index_1.RPCPing)();
            expect(message).toStrictEqual({
                jsonrpc: '2.0',
                id: 'mocked-uuid',
        ...
        it('should generate the response', function () {
            const message = (0, index_1.RPCPingResponse)('uuid', 1234);
            expect(message).toStrictEqual({
                jsonrpc: '2.0',
                id: 'uuid',
                result: {
    ...
    describe('RPCExecute', () => {
        ...
        it('should generate the message based on protocol and method', function () {
            const message = (0, index_1.RPCExecute)({ method, params });
            expect(message).toStrictEqual({
                jsonrpc: '2.0',
                id: 'mocked-uuid',
                method,
        ...
        it('should generate the message based on protocol, method and specific params', function () {
            const message = (0, index_1.RPCExecute)({
                method,
                params: { x: 3, y: 6 },
            });
            expect(message).toStrictEqual({
    ...
    describe('RPCDisconnect', () => {
        it('should generate the response', function () {
            const message = (0, index_1.RPCDisconnectResponse)('uuid');
            expect(message).toStrictEqual({
                jsonrpc: '2.0',
                id: 'uuid',
                result: {},
