...
import type { CustomSaga, SessionChannel, SwEventChannel } from '../redux/interfaces';
...
export interface BaseComponentOptionsWithPayload<CustomPayload extends unknown> {
    store: SDKStore;
    customSagas?: CustomSaga<any>[];
