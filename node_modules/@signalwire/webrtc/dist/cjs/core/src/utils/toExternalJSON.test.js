...
const toExternalJSON_1 = require("./toExternalJSON");
describe('toExternalJSON', () => {
    it('converts all the keys from snake_case to camelCase', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const input = {
            snake_case: 'test',
            another_prop: null,
            some_other_property: {
        ...
        expect((0, toExternalJSON_1.toExternalJSON)(input)).toStrictEqual(output);
    }));
    ...
    it('converts values for any specified property in `options.propsToUpdateValue`', () => {
        ...
        expect((0, toExternalJSON_1.toExternalJSON)(input, {
    ...
    it('should not change keys already camelCase-d', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const input = {
            someId: 'test',
            anotherProp: null,
            this_change: null,
    ...
    it('should not change values within array not in the whitelist', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const input = {
...
//# sourceMappingURL=toExternalJSON.test.js.map