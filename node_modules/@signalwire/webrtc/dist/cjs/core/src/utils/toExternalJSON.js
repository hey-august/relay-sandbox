...
exports.fromSnakeToCamelCase = exports.toExternalJSON = void 0;
 ...
 */
const isTimestampProperty = (prop) => {
 ...
 * @internal
 */
const toExternalJSON = (input, options = DEFAULT_OPTIONS) => {
    // @ts-expect-error
    if ((input === null || input === void 0 ? void 0 : input.__sw_symbol) || (input === null || input === void 0 ? void 0 : input.__sw_proxy)) {
        // Return if the input is a BaseComponent or a Proxy
        return input;
    }
    return Object.entries(input).reduce((reducer, [key, value]) => {
        const prop = (0, exports.fromSnakeToCamelCase)(key);
            ...
            if (Array.isArray(value)) {
                if (options.propsToUpdateValue.includes(key)) {
                    reducer[prop] = value.map((v) => {
                        if (typeof v === 'string') {
                            return (0, exports.fromSnakeToCamelCase)(v);
                        }
                        return (0, exports.toExternalJSON)(v);
                    });
                }
                else {
                    reducer[prop] = value;
                ...
                reducer[prop] = (0, exports.toExternalJSON)(value);
            }
        }
        else {
...
exports.toExternalJSON = toExternalJSON;
/**
 * Converts values from snake_case to camelCase
 * @internal
 */
const fromSnakeToCamelCase = (input) => {
    if (!input.includes('_')) {
        return input;
    }
...
//# sourceMappingURL=toExternalJSON.js.map