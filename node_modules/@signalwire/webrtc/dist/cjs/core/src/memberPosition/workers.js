...
function* memberUpdatedWorker({ action, memberList, instance, dispatcher = defaultDispatcher, }) {
    var _a, _b;
    ...
    const event = (0, __1.stripNamespacePrefix)(action.type);
...
const memberPositionWorker = function* memberPositionWorker({ instance, channels, initialState, getSession, instanceMap, dispatcher = defaultDispatcher, }) {
    ...
    while (true) {
        const action = yield __1.sagaEffects.take(swEventChannel, (action) => {
        ...
        switch (action.type) {
            case 'video.member.updated': {
                ...
                yield (0, effects_1.fork)(memberUpdatedWorker, {
                    action,
                    channels,
                    memberList,
                    instance,
            ...
            case 'video.layout.changed': {
                yield (0, effects_1.fork)(memberPositionLayoutChangedWorker, {
                    action,
                    channels,
                    memberList,
                    instance,
...
exports.memberPositionWorker = memberPositionWorker;
