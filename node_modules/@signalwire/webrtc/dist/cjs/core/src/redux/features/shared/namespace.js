...
exports.findNamespaceInPayload = void 0;
...
const findNamespaceInPayload = (action) => {
    var _a;
    ...
    if ('development' === process.env.NODE_ENV) {
        (0, utils_1.getLogger)().info('Namespace not found for action.type: ', action === null || action === void 0 ? void 0 : action.type);
    }
    return '';
};
exports.findNamespaceInPayload = findNamespaceInPayload;
