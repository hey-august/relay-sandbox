...
declare type VideoMemberEntityUpdated = InternalVideoMemberEntityUpdated;
...
/** @deprecated */
export declare type DeprecatedVideoMemberHandlerParams = {
    member: InternalVideoMemberEntity;
};
export declare type VideoMemberHandlerParams = {
 ...
 */
export declare type RoomEventNames = VideoRoomSessionEventNames | VideoMemberEventNames | VideoLayoutEventNames | VideoRecordingEventNames | VideoPlaybackEventNames | VideoStreamEventNames | RTCTrackEventName;
export declare type RoomSessionObjectEventsHandlerMap = Record<VideoRoomDeviceEventNames, (params: DeviceUpdatedEventParams) => void> & Record<VideoLayoutEventNames, (params: {
    layout: VideoLayout;
}) => void> & Record<Exclude<VideoMemberEventNames, MemberUpdated | MemberUpdatedEventNames | MemberListUpdated>, (params: VideoMemberHandlerParams) => void> & Record<Extract<VideoMemberEventNames, MemberUpdated | MemberUpdatedEventNames>, (params: VideoMemberUpdatedHandlerParams) => void> & Record<Extract<VideoMemberEventNames, MemberListUpdated>, (params: VideoMemberListUpdatedParams) => void> & Record<DeprecatedMemberUpdatableProps, (params: DeprecatedVideoMemberHandlerParams) => void> & Record<MemberTalkingEventNames, (params: VideoMemberTalkingEventParams) => void> & Record<Exclude<VideoRoomSessionEventNames, RoomLeft | RoomJoined | RoomSubscribed>, (params: VideoRoomEventParams) => void> & Record<RoomJoined | RoomSubscribed, (params: VideoRoomSubscribedEventParams) => void> & Record<RoomLeft, (params?: RoomLeftEventParams) => void> & Record<MediaEvent, () => void> & Record<VideoRoomDeviceUpdatedEventNames, (params: DeviceUpdatedEventParams) => void> & Record<VideoRoomDeviceDisconnectedEventNames, (params: DeviceDisconnectedEventParams) => void> & Record<RoomAudienceCount, (params: VideoRoomAudienceCountEventParams) => void> & Record<RTCTrackEventName, (event: RTCTrackEvent) => void> & Record<VideoRecordingEventNames, (recording: RoomSessionRecording) => void> & Record<VideoPlaybackEventNames, (recording: RoomSessionPlayback) => void> & Record<BaseConnectionState, (params: RoomSession) => void> & Record<VideoStreamEventNames, (stream: RoomSessionStream) => void>;
...
export declare type StartScreenShareOptions = {
 ...
 */
export interface CreateScreenShareObjectOptions extends StartScreenShareOptions {
}
export declare type AddDeviceOptions = {
    autoJoin?: boolean;
    audio?: MediaStreamConstraints['audio'];
    video?: MediaStreamConstraints['video'];
};
export declare type AddCameraOptions = MediaTrackConstraints & {
    autoJoin?: boolean;
};
export declare type AddMicrophoneOptions = MediaTrackConstraints & {
    autoJoin?: boolean;
};
 ...
 */
export interface RoomMethods extends OnlyFunctionProperties<VideoRoomSessionContract> {
...
export interface RoomSessionDeviceMethods extends RoomMemberSelfMethodsInterface {
}
export interface RoomScreenShareMethods extends RoomMemberSelfMethodsInterface {
}
