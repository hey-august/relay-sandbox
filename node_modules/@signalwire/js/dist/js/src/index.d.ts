...
/** @ignore @deprecated */
export declare type RoomStartedEventName = RoomStarted;
/** @ignore @deprecated */
export declare type RoomEndedEventName = RoomEnded;
/** @ignore @deprecated */
export declare type RoomSubscribedEventName = RoomSubscribed;
/** @ignore @deprecated */
export declare type RoomUpdatedEventName = RoomUpdated;
/** @ignore @deprecated */
export declare type RoomEvent = VideoRoomSessionEventNames;
/** @ignore @deprecated */
export declare type RoomMember = VideoMemberEntity & {
    type: 'member';
};
/** @ignore @deprecated */
export declare type RoomScreenShare = VideoMemberEntity & {
    type: 'screen';
};
/** @ignore @deprecated */
...
/** @ignore */
export type { BaseComponentOptions, BaseConnectionState, ClientEvents, EmitterContract, RTCTrackEventName, UserOptions, SessionStatus, SessionEvents, VideoLayout, InternalVideoLayout, VideoLayoutEventNames, VideoRoomSessionEventNames, VideoRoomEventParams, VideoMemberEntity, VideoMemberEventNames, MemberTalkingEventNames, VideoMemberTalkingEventParams, InternalVideoMemberEntity, } from '@signalwire/core';
/** @ignore */
export type { BaseConnectionOptions, ConnectionOptions, } from '@signalwire/webrtc';
/** @ignore */
export type { RoomSessionObjectEventsHandlerMap, RoomSessionObjectEvents, RoomSessionObjectEventsHandlerMap as RoomObjectEventsHandlerMap, RoomSessionObjectEvents as RoomObjectEvents, RoomEventNames, } from './utils/interfaces';
